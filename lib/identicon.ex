defmodule Identicon do
  ...
  ## Examples
    iex(1)> Identicon.hash_input("fantasma")
  ...
  @doc """
  Builds a 5x5 grid
  The identicon is bilateral symmetry.
  ...
  ## Example
    iex(1)> "Hello" |> hash_input |> pick_color |> build_grid
  ...
  ## Example
    iex(1)> "Hello" |> hash_input |> pick_color |> build_grid |> filter_odd_squares |> build_pixel_map
    %Identicon.Image{color: {193, 165, 41},
    grid: [{158, 7}, {232, 11}, {232, 13}, {98, 15}, {98, 19}, {252, 20}, {32, 21},
    {32, 23}, {252, 24}],
    hex: [193, 165, 41, 143, 147, 158, 135, 232, 249, 98, 165, 237, 252, 32, 105,
